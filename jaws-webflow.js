 ...
 * GSAP Animations and Effects for Webflow
 * 
 * Usage: Add this script to your Webflow project
 * Dependencies: GSAP, ScrollTrigger, CustomEase, SplitText, Lenis
 */
...
(function() {
    ...
    function init() {
        if (typeof gsap === 'undefined') {
            console.warn('GSAP is not loaded. Please include GSAP before this script.');
            return;
        }

        // Register GSAP plugins
        if (typeof ScrollTrigger !== 'undefined') gsap.registerPlugin(ScrollTrigger);
        if (typeof CustomEase !== 'undefined') CustomEase.create("menuExpo", "0.16,1,0.3,1");
    ...
    function initMenuAnimations() {
        ...
        const ease = typeof CustomEase !== 'undefined' ? "menuExpo" : "expo.out";
        let isOpen = false;
