 ...
 * GSAP Animations and Effects Module
 * 
 * Usage: <script type="module" src="https://your-site.netlify.app/main.js"></script>
 * 
 * Dependencies: GSAP, ScrollTrigger, CustomEase, SplitText, Lenis
 */

// Import GSAP and plugins from CDN
...
function init() {
  ...
  script.src = 'https://cdn.jsdelivr.net/npm/@studio-freight/lenis@1.0.39/bundled/lenis.min.js';
  script.onload = () => {
    initLenis();
  };
